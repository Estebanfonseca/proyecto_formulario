  ...
  const handleChange = (e) => {
    ...
    if (name === "estado") {
      ...
      switch (value) {
        ...
        case "devuelto":
          setOptions([
            "No ha sido posible contactar al usuario",
            "No acepta coordinacion de servicio",
            "No acepta coordinacion de servicio - Requiere correccion",
            "Usuario Hospotalizado",
            "Reprogramacion de citas",
            "Toma servicios sus propios medios",
            "No requiere servicios",
            "Cups autorizado errado",
            "Cantidades erradas",
            "Fechas erradas",
            "Autorizacion Anulada",
            "Informacion de acompañante no corresponde",
            "Sin disponibilidad Aerea",
            "Servicio duplicado con otra autorizacion",
            "Ya tiene abierto, se requiere penalidad",
            "No existe un tiquete en abierto, por lo que se requiere un nuevo tiquete",
            "Sin proveedor en desstino",
          ]);
          break;
        default:
          setOptions([]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (error.response) {
        ...
        alert(
          "No se pudo contactar con el servidor. Verifica tu conexión a internet."
        );
      } else {
    ...
    <div style={styles.formulario}>
      ...
      <main style={styles.main}>
        <form onSubmit={handleSubmit} style={styles.form}>
          ...
          <div style={styles.formGroup}>
            <label htmlFor="autorizacion" style={styles.label}>
              Autorización:
            </label>
            <input
              type="text"
          ...
          <div style={styles.formGroup}>
            <label htmlFor="radicado" style={styles.label}>
              Radicado:
            </label>
            <input
              type="text"
          ...
          <div style={styles.formGroup}>
            <label htmlFor="tipoServicio" style={styles.label}>
              Tipo de Servicio:
            </label>
            <select
              id="tipoServicio"
          ...
          <div style={styles.formGroup}>
            <label htmlFor="identificador" style={styles.label}>
              Identificador:
            </label>
            <input
              type="text"
